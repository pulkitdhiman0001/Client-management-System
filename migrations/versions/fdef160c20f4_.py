...
Revision ID: fdef160c20f4
Revises: 52932eb8da96
Create Date: 2023-01-25 16:33:31.071845
...
revision = 'fdef160c20f4'
down_revision = '52932eb8da96'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('payment_voucher', schema=None) as batch_op:
        ...
        batch_op.alter_column('bill',
               ...
               type_=sa.Integer(),
               existing_nullable=True)
        batch_op.create_foreign_key(None, 'records', ['bill'], ['id'])
